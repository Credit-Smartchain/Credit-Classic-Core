...
from test_framework.creditconfig import ENABLE_REDUCED_BLOCK_TIME

import sys


RPC_INVALID_PARAMETER = -8
class CreditRPCSearchlogsTestModified(BitcoinTestFramework):
...
if __name__ == '__main__':
    CreditRPCSearchlogsTestModified().main()