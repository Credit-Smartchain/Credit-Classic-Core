...
class CreditSimpleDelegationContractTest(BitcoinTestFramework):
    ...
    """
        - Check that it is not possible to use an input with less value than 100 credit as the first input to the coinstake.
        - Check that 100 credit is just enough for the first input to the coinstake.
    """
    def nas_staker_must_be_100_credit_test(self):
        use_pos_reward = True if self.staker.getblockcount() > 5000 else False
    ...
    def run_test(self):
        ...
        print("nas_staker_must_be_100_credit_test")
        self.nas_staker_must_be_100_credit_test()
        self.sync_all()
...
if __name__ == '__main__':
    CreditSimpleDelegationContractTest().main()
