...
ADDRESS_BCRT1_UNSPENDABLE = 'tcrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqen882c'
...
def program_to_witness(version, program, main = False):
    ...
    return segwit_addr.encode("tc" if main else "tcrt", version, program)
