...
class ImportMultiTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses = [convert_btc_address_to_credit("2N7yv4p8G8yEaPddJxY41kPihnWvs39qCMf"), convert_btc_address_to_credit("2MsHxyb2JS3pAySeNUsJ7mNnurtpeenDzLA")] # hdkeypath=m/0'/0'/0' and 1'
        addresses += [convert_btc_bech32_address_to_credit("bcrt1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju7scl8gn"), convert_btc_bech32_address_to_credit("bcrt1qfqeppuvj0ww98r6qghmdkj70tv8qpchehegrg8")] # wpkh subscripts corresponding to the above addresses
        ...
        address = convert_btc_address_to_credit("2MuhcG52uHPknxDgmGPsV18jSHFBnnRgjPg")
        ...
        addresses = [
            'tcrt1qtmp74ayg7p24uslctssvjm06q5phz4yrgnnq8p', # m/0'/0'/0
            'tcrt1q8vprchan07gzagd5e6v9wd7azyucksq2gh4jz2', # m/0'/0'/1
            'tcrt1qtuqdtha7zmqgcrr26n2rqxztv5y8rafj0255t3', # m/0'/0'/2
            'tcrt1qau64272ymawq26t90md6an0ps99qkrse6gsjpz', # m/0'/0'/3
            'tcrt1qsg97266hrh6cpmutqen8s4s962aryy77uwypuz', # m/0'/0'/4
        ]
        result = wrpc.importmulti(
            [{
