...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " credit-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  credit-tx [options] <hex-tx> [commands]  Update hex-encoded credit transaction\n" +
            "or:     credit-tx [options] -create [commands]   Create hex-encoded credit transaction\n" +
            "\n";
