...
struct Params {
    ...
    /** Block height at which CIP5 becomes active */
    int CIP5Height;
    /** Block height at which CIP6 becomes active */
    int CIP6Height;
    /** Block height at which CIP7 becomes active */
    int CIP7Height;
    /** Block height at which CIP9 becomes active */
    int CIP9Height;
    ...
    {
        return height < CIP9Height ? nPowTargetTimespan : 
