#ifndef CREDITVERSIONCHECKER_H
#define CREDITVERSIONCHECKER_H

#include <QObject>

#define CREDIT_RELEASES "https://github.com/The-Terra-Foundation/Credit-Core/releases"
...
class CreditVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit CreditVersionChecker(QObject *parent = 0);
    ~CreditVersionChecker();
