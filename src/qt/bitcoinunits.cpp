...
QString BitcoinUnits::longName(int unit)
{
    ...
    case uBTC: return QString::fromUtf8("μCREDIT (bits)");
...
QString BitcoinUnits::description(int unit)
{
    ...
    case mBTC: return QString("Milli-Credits (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Credits (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
