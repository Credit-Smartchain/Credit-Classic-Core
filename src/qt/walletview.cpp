    ...
    walletFrame(qobject_cast<WalletFrame*>(parent))
{
    ...
    QPushButton *exportButton = new CreditPushButton(tr("&Export"), this);
    ...
    CRCTokenPage = new CRCToken(platformStyle);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    CRCTokenPage->setClientModel(_clientModel);
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    CRCTokenPage->setModel(_walletModel);
