...
//    initState();
    ...
    std::vector<CreditTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createCreditTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createCreditTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createCreditTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createCreditTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
