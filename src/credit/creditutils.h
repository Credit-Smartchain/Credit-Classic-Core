#ifndef CREDITUTILS_H
#define CREDITUTILS_H

#include <libdevcore/Common.h>
#include <libdevcore/FixedHash.h>

/**
 * creditutils Provides utility functions to EVM for functionalities that already exist in credit
 */
namespace creditutils
{
/**
