#ifndef CREDITDELEGATION_H
#define CREDITDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The ICreditStaker class Delegation filter
 */
...
/**
 * @brief The CreditDelegation class Communicate with the credit delegation contract
 */
class CreditDelegation {
    
public:
    /**
     * @brief CreditDelegation Constructor
     */
    CreditDelegation();

    /**
     * @brief ~CreditDelegation Destructor
     */
    virtual ~CreditDelegation();
...
private:
    CreditDelegation(const CreditDelegation&);
    CreditDelegation& operator=(const CreditDelegation&);
    CreditDelegationPriv* priv;
};
#endif
