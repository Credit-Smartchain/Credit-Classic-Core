...
public:
    ...
    bool IsProofOfWork() const // credit
    {
...
public:
    ...
    SERIALIZE_METHODS(CDiskBlockIndex, obj)
    {
        ...
        READWRITE(obj.hashStateRoot); // credit
        READWRITE(obj.hashUTXORoot); // credit
        READWRITE(obj.nStakeModifier);
        READWRITE(obj.prevoutStake);
        READWRITE(obj.hashProof);
        READWRITE(obj.vchBlockSigDlgt); // credit
    }
