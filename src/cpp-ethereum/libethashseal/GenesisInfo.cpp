...
#include "genesis/creditMainNetwork.cpp"
...
#include "genesis/test/creditTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::creditMainNetwork: return c_genesisInfoCreditMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::creditTestNetwork: return c_genesisInfoCreditTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::creditMainNetwork: return c_genesisStateRootCreditMainNetwork;
    case Network::creditTestNetwork: return c_genesisStateRootCreditTestNetwork;
