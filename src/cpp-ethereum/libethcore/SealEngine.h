...
////////////////////////////////////////////////////////////// // credit
    void setCreditSchedule(EVMSchedule _creditSchedule) const { creditSchedule = _creditSchedule; }

    EVMSchedule& getCreditSchedule() const { return creditSchedule; }
...
private:
    ...
    mutable EVMSchedule creditSchedule; // credit
